import expression.ExpressToken
import expression.ExpressTokenType
...
class Fnlpe(private val exp: String, private val komoranModel: DEFAULT_MODEL = DEFAULT_MODEL.LIGHT) {
    private val nlpEngine = Komoran(komoranModel) // Komoran NLP Engine
    private val expEngine = ExpressionParser(exp) // FNLPE Parser

    private val expTokens = getExpTokens() // expression Tokens
